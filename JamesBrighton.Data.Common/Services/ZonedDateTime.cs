...
#pragma warning restore CS8618
	...
	public static void RegisterClass()
	{
		...
		Serializer2.AddAfterDeserializeConverter<ZonedDateTime>((o) =>
		{
			var obj = (ZonedDateTime)o;
			return new FbZonedDateTime(new DateTime(obj.DateTimeInTicks, DateTimeKind.Utc), obj.TimeZone);
		});
	}
}